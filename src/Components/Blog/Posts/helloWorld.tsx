...
export function helloWorld() {
  return (
    <div>
      <div>
        I have no idea how to begin writing this post, I've been writing and deleting whole lines for atleast half an hour. my own mindless social media consumption (To be honest I try to finish this
        one again and again every 2-3 months).
      </div>
      <div>
      ...
      <div>I intend for this blog to serve as an extension of that general experiment.</div>
    </div>
  );
}
